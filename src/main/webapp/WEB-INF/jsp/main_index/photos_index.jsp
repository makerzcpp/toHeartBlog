...
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no">
		...
		<link rel="icon" href="${BASE}/images/photosindex/favicon.ico">
		<link rel="shortcut icon" href="${BASE}/images/photosindex/favicon.ico" />
		<link rel="stylesheet" href="${BASE}/css/photosindex/style.css">
...
<div class="content"><div class="ic">More Website Templates @ TemplateMonster.com - December 30, 2013!</div>
 ...
 <%@ include file="foot.jsp"%>
 		<script src="${BASE}/js/photosindex/jquery-migrate-1.1.1.js"></script>
		<script src="${BASE}/js/photosindex/script.js"></script>
		<script src="${BASE}/js/photosindex/jquery.ui.totop.js"></script>
		<script src="${BASE}/js/photosindex/superfish.js"></script>
		<script src="${BASE}/js/photosindex/jquery.equalheights.js"></script>
		<script src="${BASE}/js/photosindex/jquery.mobilemenu.js"></script>
		<script src="${BASE}/js/photosindex/jquery.easing.1.3.js"></script>
		<script>
		BASE = '${BASE}';
