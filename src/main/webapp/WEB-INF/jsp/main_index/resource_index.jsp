...
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no">
		<link href="${BASE}/css/resource_index/common.css" type="text/css" rel="stylesheet">
		<link href="${BASE}/css/resource_index/resourse.css" type="text/css" rel="stylesheet">
		<script src="${BASE}/js/jquery-1.11.0.min.js" type="text/javascript"></script>
		<script type="text/javascript" src="${BASE}/js/resource_index/all.js"></script>
		<script type="text/javascript" src="${BASE}/js/resource_index/pagenav.js"></script>
		<script type="text/javascript" src="${BASE}/js/resource_index/resourceList.js"></script>
