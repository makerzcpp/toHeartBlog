...
<title>修改友情链接 - 心博</title>
<link rel="stylesheet" type="text/css" href="${BASE}/css/backstage/bootstrap.min.css">
<link rel="stylesheet" type="text/css" href="${BASE}/css/backstage/style.css">
<link rel="stylesheet" type="text/css" href="${BASE}/css/backstage/font-awesome.min.css">
<link rel="apple-touch-icon-precomposed" href="${BASE}/images/backstage/icon/icon.png">
<link rel="shortcut icon" href="${BASE}/images/backstage/icon/favicon.ico">
<script src="${BASE}/js/backstage/jquery-2.1.4.min.js"></script>
<!--[if gte IE 9]>
  <script src="${BASE}/js/backstage/jquery-1.11.1.min.js" type="text/javascript"></script>
  <script src="${BASE}/js/backstage/html5shiv.min.js" type="text/javascript"></script>
  <script src="${BASE}/js/backstage/respond.min.js" type="text/javascript"></script>
  <script src="${BASE}/js/backstage/selectivizr-min.js" type="text/javascript"></script>
<![endif]-->
<!--[if lt IE 9]>
          ...
          <div class="col-md-9">
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                <input type="text" id="flink-name" name="name" class="form-control" value="心博" placeholder="在此处输入名称" required autofocus autocomplete="off">
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                <input type="text" id="flink-imgurl" name="imgurl" class="form-control" value="http://www.ylsat.com/${BASE}/images/backstage/logo.png" placeholder="在此处输入图像地址" required autocomplete="off">
                <span class="prompt-text">图像地址是可选的，可以为网站LOGO地址等</span> </div>
            </div>
            <div class="add-article-box">
              <h2 class="add-article-box-title"><span>描述</span></h2>
              <div class="add-article-box-content">
                <textarea class="form-control" name="describe" autocomplete="off">备注：心博</textarea>
...
<div class="modal fade user-select" id="WeChat" tabindex="-1" role="dialog" aria-labelledby="WeChatModalLabel">
  <div class="modal-dialog" role="document" style="margin-top:120px;max-width:280px;">
    <div class="modal-content">
      ...
      <div class="modal-body" style="text-align:center"> <img src="${BASE}/images/backstage/weixin.jpg" alt="" style="cursor:pointer"/> </div>
    </div>
  </div>
</div>
<!--提示模态框-->
<div class="modal fade user-select" id="areDeveloping" tabindex="-1" role="dialog" aria-labelledby="areDevelopingModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body"> <img src="${BASE}/images/backstage/baoman/baoman_01.gif" alt="深思熟虑" />
        <p style="padding:15px 15px 15px 100px; position:absolute; top:15px; cursor:default;">很抱歉，程序猿正在日以继夜的开发此功能，本程序将会在以后的版本中持续完善！</p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" data-dismiss="modal">朕已阅</button>心博
      </div>
    </div>
  </div>
</div>
...
<script src="${BASE}/js/backstage/bootstrap.min.js"></script>
<script src="${BASE}/js/backstage/admin-scripts.js"></script>
</body>
</html>