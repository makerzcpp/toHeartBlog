...
<meta charset="utf-8">
	...
	<link rel="stylesheet" type="text/css" href="${BASE}/css/showDialog/showDialog.css" />
	<!-- Animate.css -->
	<link rel="stylesheet" href="${BASE}/css/login_css/animate.css">
	<!-- Icomoon Icon Fonts-->
	<link rel="stylesheet" href="${BASE}/css/login_css/icomoon.css">
	<!-- Themify Icons-->
	<link rel="stylesheet" href="${BASE}/css/login_css/themify-icons.css">
	<!-- Bootstrap  -->
	<link rel="stylesheet" href="${BASE}/css/login_css/bootstrap.css">

	<!-- Magnific Popup -->
	<link rel="stylesheet" href="${BASE}/css/login_css/magnific-popup.css">

	<!-- Owl Carousel  -->
	<link rel="stylesheet" href="${BASE}/css/login_css/owl.carousel.min.css">
	<link rel="stylesheet" href="${BASE}/css/login_css/owl.theme.default.min.css">

	<!-- Theme style  -->
	<link rel="stylesheet" href="${BASE}/css/login_css/style.css">

	<!-- Modernizr JS -->
	<script src="${BASE}/js/login/modernizr-2.6.2.min.js"></script>
	<!-- FOR IE9 below -->
	<!--[if lt IE 9]>
...
<body>
	...
	<header id="gtco-header" class="gtco-cover" role="banner" style="background-image:url(${BASE}/images/login.jpg)">
	...
	<!-- jQuery Easing -->
	<script src="${BASE}/js/login/jquery.easing.1.3.js"></script>
	<!-- Bootstrap -->
	<script src="${BASE}/js/login/bootstrap.min.js"></script>
	<!-- Waypoints -->
	<script src="${BASE}/js/login/jquery.waypoints.min.js"></script>
	<!-- Carousel -->
	<script src="${BASE}/js/login/owl.carousel.min.js"></script>
	<!-- countTo -->
	<script src="${BASE}/js/login/jquery.countTo.js"></script>
	<!-- Magnific Popup -->
	<script src="${BASE}/js/login/jquery.magnific-popup.min.js"></script>
	<script src="${BASE}/js/login/magnific-popup-options.js"></script>
	<!-- Main -->
	<script src="${BASE}/js/login/main.js"></script>
	<!-- 登录 -->
