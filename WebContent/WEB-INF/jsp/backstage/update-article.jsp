...
<script src="${BASE}/www/js/backstage/lib/ueditor/ueditor.config.js"></script> 
<script src="${BASE}/www/js/backstage/lib/ueditor/ueditor.all.min.js"> </script> 
<script src="${BASE}/www/js/backstage/lib/ueditor/lang/zh-cn/zh-cn.js"></script>  
