...
<!--summernote富文本编辑器-->
<link rel="stylesheet" type="text/css" href="${BASE}/www/js/backstage/lib/summernote/summernote.css">
<script src="${BASE}/www/js/backstage/lib/summernote/summernote.js"></script> 
<script src="${BASE}/www/js/backstage/lib/summernote/lang/summernote-zh-CN.js"></script> 
<script>
